...
import fieldReducer from './format/field_reducer.ts';
import groupbyReducer from './format/groupby_reducer.ts';
import orderbyReducer from './format/orderby_reducer.ts';
import reduceConditions from './format/reducer_conditions.ts';
import limitClause from './format/limit_clause.ts';
import joinHandler from './format/join_handler.ts';
...
import type {default as Dare, QueryOptions} from './index.ts';
 ...
 * Format Request
 *
 * @param options - Current iteration
 * @param dareInstance - Instance of Dare
 * @returns formatted object with all the joins
 */
async function format_request(
	 ...
	 * @param propName - Type of item
	 * @param isArray - Is array, otherwise expect object
	 * @param key - Key to extract
	 * @param value - Value to extract
	 */
	function extractJoined(
		propName: string,
		isArray: boolean,
		key: string,
		value: any
	...
	/** Join conditions */
	const sql_join_condition: Array<Sql> = [];
	...
	// Joins
	{
		const joins: Array<QueryOptions> = options.joins || [];
