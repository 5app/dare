...
// Response
export default function responseHandler(this: Dare, resp: any[]): any[] {
...
export function responseRowHandler(
	this: Dare,
...
// Format
function formatHandler(item: Record<string, any>, dareInstance?: Dare) {
 ...
 * @param obj.label - Name of the property to be created
 * @param obj.field - Name of the property to be created
 * @param obj.handler - Function to process the request
 * @param obj.targetAddress - Paths of the target item
 * @param obj.target - Obj where the new prop will be appended
 * @param obj.extraFields - List of fields which can be removed from the response
 * @param dareInstance - Dare Instance
 * @returns Modifies the incoming request with new props
 */
 ...
 *
 * @param requestPath - String denoting the path of the props
 * @param item - Item with the nested props
 * @param extraFields - extrafields which can be removed afterwards
 * @returns Props object
 */
function getHandlerPropsByAddress(
	requestPath: string,
